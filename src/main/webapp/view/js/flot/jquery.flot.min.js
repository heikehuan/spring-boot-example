...
(function (e) {
    ...
    function r(t, r, s, o) {
        ...
        function D() {
            t.css("padding", 0).children(":not(.flot-common,.flot-overlay)").remove(), t.css("position") == "static" && t.css("position", "relative"), f = new n("flot-common", t), l = new n("flot-overlay", t), h = f.context, p = l.context, c = e(l.element).unbind();
            var r = t.data("plot");
